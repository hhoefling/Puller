...
def getsolltokens():
	...
	if 'bat' in modules:
		...
		srcsolltokens.append(['openWB/housebattery/enable_discharge_max', 'openWB/set/houseBattery/enable_discharge_max'])
		srcsolltokens.append(['openWB/housebattery/load_minutes',         'openWB/housebattery/load_minutes'])
		srcsolltokens.append(['openWB/housebattery/iskalib',              'openWB/housebattery/iskalib'])
